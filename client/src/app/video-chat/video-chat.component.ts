...
private dialogRef : MatDialogRef<VideoChatComponent> = inject(MatDialogRef);
 private ringtone: HTMLAudioElement;
  ...
  constructor() {
    this.ringtone = new Audio('assets/audio/mixkit-on-hold-ringtone-136.mp3');
    this.ringtone.loop = true; // Keeps ringing until stopped
  }
...
setupSignalListeners() {
    // Store incoming ICE candidates until remote description is set
